...
def set_arguments():
    ...
    sg = parser.add_argument_group(title="storage_generic", description="Generic options for storage devices")
    ...
    ss = parser.add_argument_group(title="storage_smart",  description="Options based on SMART values of storage devices")
